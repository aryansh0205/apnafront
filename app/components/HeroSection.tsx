          ...
          <div key={index} className="w-full flex-shrink-0 relative h-[600px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-center">
              <div className="max-w-4xl px-4 text-white relative z-10">
                ...
                <button className="bg-[#F03C56] hover:bg-red-700 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold transition-colors duration-300 text-sm sm:text-base">
                  {slide.buttonText}
                </button>
              </div>
            </div>
