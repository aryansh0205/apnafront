  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16">
      ...
      <div className="flex flex-col md:flex-row gap-3 w-full  justify-center">
        {/* Left Column (1-2) */}
        <div className="flex flex-col space-y-3 md:w-[270px]">
          {kanpurPlaces.slice(0, 2).map((place) => (
            <motion.div
              key={place.id}
              className={`relative rounded-xl overflow-hidden ${place.size} ${place.width}`}
              whileHover={{ scale: 1.03 }}
              transition={{ duration: 0.3 }}
            >
              <Image
        ...
        <div className="flex flex-col space-y-3 md:w-[470px]">
          <motion.div
            className={`relative rounded-xl overflow-hidden ${kanpurPlaces[3].size} ${kanpurPlaces[3].width}`}
            whileHover={{ scale: 1.03 }}
            transition={{ duration: 0.3 }}
          >
            <Image
